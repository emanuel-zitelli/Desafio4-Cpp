...
bool mostrarLista(std::vector<iVehiculoBase*>& lista) // Devuelve un bool para saber si hay vehiculos. Si no hay no quiero habilitar los inputs
{   
    system("cls");
...
void limpieza(std::vector<iVehiculoBase*>& lista) // para liberar la memoria. De paso limpiamos los punteros que no apuntan a nada
{   
...
void agregarVehiculo(std::vector<iVehiculoBase*>& listadoVehiculos) //, iMantenimiento* mantenimiento
{
